      ...
      <div className='w-full flex justify-between items-start mx-auto'>
          <Link
            ...
            onClick={() => {
              // setActive("hero");
              window.scrollTo(0, 0);
              window.open("https://drive.google.com/file/d/1ie8ZbCXiQ8gGicA8OW4Mmfh1JtPvK4pa/view", "_blank");
            }}
          >
            <p className='text-white text-[26px] lg:text-[36px] font-bold pointer-events-auto cursor-pointer flex'>
            <span className="text-white-500 hover:text-yellow-400 transition-all duration-300 ease-in-out hover:scale-125">
              MP
            </span>
            </p>
          </Link>
          ...
          {navLinks.map((nav) => (
            <li
              ...
              className={`relative flex items-center ${
                active === nav.id ? "text-white" : "text-sky-400"
